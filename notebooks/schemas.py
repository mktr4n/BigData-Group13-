...
# Expected row counts, snapshot 2026-08-25. Used as assertions by the export
# and benchmark notebooks so a partial read fails loudly instead of quietly
# producing wrong timings.
EXPECTED_ROWS = {
    "companies": 1171373,
    "financial_data": 1170290,
}
