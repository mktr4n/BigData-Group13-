...
pretty-printed JSON array of 1,908 MB, which Spark can read only with
...
across all four variants against A as reference. Group keys and integer counts
...
The tolerance is precautionary. Simulated reassociation of 300,000 mixed-magnitude
